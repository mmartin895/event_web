...
import classes from "./AdminEventOverview.module.scss";
...
import CalendarOverview from "../EventOverviewPage/CalendarOverview/CalendarOverview";
import moment from "moment";

const { Search } = Input;

function AdminEventOverview(props) {
